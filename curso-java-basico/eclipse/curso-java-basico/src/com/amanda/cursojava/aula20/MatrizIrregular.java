...
public class MatrizIrregular {
	...
	// avenida mais movimentada da cidade onde você mora. A pesquisa consiste em perguntar ao cidadão
	// a quantidade de filho e o nome de cada filho. Guarde essas informações em uma matriz de forma
	// que cada pessoa entrevistada ocupe somente o espaço necessário na memória para guardar o nome
